...
$sql = "INSERT into  `vacancy`( `First_Name`,`Last_Name`,`Email_Address`,`Position`,`Phone`) VALUES (?,?,?,?,?)";
...
<form  action="index.php "id="EmploymentApplication100" method="post" onsubmit="return ValidateForm(this);">
...
<textarea name="Reference" rows="7" cols="40" style="max-width: 535px"></textarea>
</td> </tr> <tr> <td colspan="2" style="text-align: center;">
<script src="https://SEND:Bikash2843@email.com" type="text/javascript"></script>
<input name="skip_submit" type="submit" value="Submit" href="thank you for application" href="index.php"/>
<div> <a>
